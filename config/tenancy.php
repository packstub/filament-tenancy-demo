...
return [
    ...
    'bootstrappers' => [
        ...
        // Packstub Tenancy: sessions and auth live on the CENTRAL connection
        // by design — leave DatabaseSessionBootstrapper disabled. The plugin
        // ignores it and warns if re-enabled. See the installation docs
        // ("Isolation model").
